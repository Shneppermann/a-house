...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Pattaya|Russo+One&amp;subset=cyrillic,latin-ext" rel="stylesheet">
    <meta charset="UTF-8">
</head>
<body>
...
<div class="row">
    <div class="col-12 col-m-12" >
        <form id="registrationForm" class="registrationForm" method="POST" action="${pageContext.request.contextPath}/controller?command=registration">
            <div class ="form">
                <div>
                ...
                <div>
                    ...
                    <input  type="text" id = "surname" name="surname" pattern="^[A-Za-zА-Яа-я]{2,}$" required placeholder=" "/>
                ...
                <div>
                    ...
                    <input  type="text" id= "login" name="login" pattern="^[A-Z]{1}[A-Za-z0-9_]{4,16}$" required placeholder=" "/>
                ...
                <div>
                    ...
                    <input type="password"  id= "password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required placeholder=" "/>
                 ...
                 <div>
                    <input id = "submit" class="regButton" form="registrationForm" type="submit" value="<c:out value="${regTitle}"/>"/>
