...
public class DirectServiceTest {
    ...
    public void shouldReturnCorrectListWhenUserNotOwnerAndHighBidNotEquals() throws LogicException,DAOException{
        ...
        Mockito.when(lotDao.findAllDirectBiddingLots()).thenReturn(expected);
        ...
        List<Lot> actual = service.getDirectLotList(TestInfo.INT_RESULT);
        ...
        Mockito.verify(lotDao,Mockito.times(1)).findAllDirectBiddingLots();
    ...
    public void shouldThrowLogicExceptionWhenLotDaoThrowsDaoException() throws LogicException,DAOException{
        ...
        Mockito.when(lotDao.findAllDirectBiddingLots()).thenThrow(new DAOException());

        DirectService service = new DirectService(lotDao,bidDao);
        service.getDirectLotList(TestInfo.INT_RESULT);
